...
public class BookBusListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Context context = parent.getContext();
            ...
            convertView = inflater.inflate(R.layout.book_bus_item, parent, false);


        // 화면에 표시될 View(Layout이 inflate된)으로부터 위젯에 대한 참조 획득
        TextView stationName = (TextView)convertView.findViewById(R.id.book_station);
        TextView busNum = (TextView) convertView.findViewById(R.id.book_busNum);
        TextView predictOne= (TextView) convertView.findViewById(R.id.book_predictOne) ;
        TextView predictTwo = (TextView) convertView.findViewById(R.id.book_predictTwo);
        TextView firstSt = (TextView) convertView.findViewById(R.id.book_firstSt);
        TextView lastSt = (TextView) convertView.findViewById(R.id.book_lastSt);
        final CheckBox bookBox = (CheckBox)convertView.findViewById(R.id.book_busBook);
        ImageView busImg = (ImageView)convertView.findViewById(R.id.book_stationBusImg);
        ...
        stationName.setText(busDTO.getStationName());
        bookBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                params.put("stationId", busDTO.getStationId());
                params.put("isBook", "0");
