...
public class RequestBundle {
	...
	private static final PlanetXSDKConstants.CONTENT_TYPE CONTENT_TYPE = ;
	/***
	 ...
	 * GET PUT POST DELETE
	 */
	private PlanetXSDKConstants.HttpMethod httpMethod;

	/***
	 * Request시에 Payload에 실리는 Content Type
	 */
	private PlanetXSDKConstants.CONTENT_TYPE requestType;

	/***
	 * Response Content Type (Accept)
	 */
	private PlanetXSDKConstants.CONTENT_TYPE responseType;
	...
	public RequestBundle() {
		...
		this.httpMethod = PlanetXSDKConstants.HttpMethod.GET;
